package fr.univavignon.transpolosearch.processing.external;
...
import fr.univavignon.transpolosearch.processing.AbstractDelegateRecognizer;
...
{	
     ...
     * to objects compatible with the rest of the software.
     * 
     * @param article
     * 		Article to process.
     * @return
    ...
    */
	 ...
	 * into the mention list used internally by the software. The file to be
